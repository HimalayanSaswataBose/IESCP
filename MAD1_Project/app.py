...
connection.commit()
cursor.execute("CREATE TABLE IF NOT EXISTS ad_requests ( sponsor TEXT, influencer TEXT, campaignName TEXT, adName TEXT, stipend TEXT, UNIQUE (sponsor, influencer, campaignName, adName))")
connection.commit()
cursor.execute("CREATE TABLE IF NOT EXISTS negotiations ( negotiator TEXT, negotiatee TEXT, campaignName TEXT, adName TEXT, initial_amount TEXT, negotiated_amount TEXT, user_type TEXT, UNIQUE (negotiator, negotiatee, campaignName, adName) )")
connection.commit()
cursor.execute("CREATE TABLE IF NOT EXISTS ongoing_ad ( sponsor TEXT, influencer TEXT, campaignName TEXT, adName TEXT, stipend TEXT, UNIQUE (sponsor, influencer, campaignName, adName))")
connection.commit()
cursor.execute("CREATE TABLE IF NOT EXISTS log_influencer ( date TEXT, influencer TEXT, activity TEXT, UNIQUE(data))")
connection.commit()
cursor.execute("CREATE TABLE IF NOT EXISTS log_sponsor ( date TEXT, sponsor TEXT, activity TEXT, UNIQUE(date))")
connection.commit()
